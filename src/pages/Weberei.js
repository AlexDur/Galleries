    ...
    <>
      <div className="page_container">
        ...
        <p>
          ...
          wurde, um die zahlreichen Frauen unterzubringen, die sich um Aufnahme
          ins Bauhaus beworben hatten. Seitens des Bauhauses war es nicht
          vorgesehen, alle Ausbildungsplätze zur Hälfte mit Frauen und Männern
          zu belegen. 1920 wurde die Frauenklasse in die Klasse für Textil
          überführt. In sie konnten auch Männer eintreten, was aber die Ausnahme
          blieb. Oskar Schlemmer spottete über die Weberei folgendermaßen:
        </p>
        <br />
        <img src={teppich1} alt="Teppich_Anna Stölzl" />
      </div>
    </>
  );
};
